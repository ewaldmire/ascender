...
Default execution environment for climber
--------------------------------------
...
The ``awx.awx`` collection is a subset of content included in the default climber |ee|. More details can be found in the `awx-ee repository <https://github.com/ansible/awx-ee>`_.
