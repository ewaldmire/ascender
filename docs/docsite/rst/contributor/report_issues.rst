...
To report issues you find in the climber documentation, use the GitHub `issue tracker <github.com/ctrliq/climber/issues>`_ for filing bugs. In order to save time, and help us respond to issues quickly, make sure to fill out as much of the issue template
...
See `How issues are resolved <github.com/ctrliq/climber/blob/main/ISSUES.md#how-issues-are-resolved>`_ for more information about the triaging and resolution process.
