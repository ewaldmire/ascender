...
**Management Jobs** assist in the cleaning of old data from climber, including system tracking information, tokens, job histories, and activity streams. You can use this if you have specific retention policies or need to decrease the storage used by your climber database. Click **Management Jobs** from the left navigation bar.
...
.. note::
    ...
    The initial job run for an climber resource (e.g. Projects, Job Templates) is excluded from **Cleanup Job Details**, regardless of retention value.
