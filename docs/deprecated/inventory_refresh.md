...
climber should have an inventory view that is more aligned towards systems management
...
## Fact Searching
Facts generated by an Ansible playbook during a Job Template run are stored by climber into the database
...
access to in climber. If the user wants to restrict their search in anyway, they will
